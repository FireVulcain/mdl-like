...
import { Loader2, Pin, Search, UserRound, UserRoundMinus, UserRoundPlus } from "lucide-react";
import {
    excludeRadarActor,
    pinRadarActor,
    restoreRadarActor,
...
// Management panel for the home "From Actors You Watch" radar: add/pin actors,
// remove or restore them. Rendered on the /settings page.
export function ActorRadarManagePanel({
    scannedActors,
    excludedActors,
}: {
