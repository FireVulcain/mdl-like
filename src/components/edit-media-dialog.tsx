                ...
                <div className="flex flex-col md:flex-row min-h-[400px]">
                    ...
                    <div className="md:w-1/4 bg-muted/30 border-r p-4 space-y-4">
                        ...
                        <div className="space-y-1">
                            <Button variant="ghost" className="w-full justify-start font-semibold bg-accent/50">
                                General
                            </Button>
                    ...
                    <div className="md:w-3/4 p-6 space-y-6">
                        ...
                        {/* Share Placeholder */}
                        <div className="grid grid-cols-[120px_1fr] items-center gap-4">
                            <label className="font-bold text-base">Share</label>
                        ...
                        {/* Episodes */}
                        <div className="grid grid-cols-[120px_1fr] items-center gap-4">
                            <label className="font-bold text-base">Episodes Watched</label>
                            <div className="flex items-center gap-3">
                                <Input
                                    ...
                                    className="w-20"
                                />
                                <div className="text-base">/ {displayTotalEp || "?"}</div>
                                <Button variant="outline" size="sm" onClick={() => setFormData((prev) => ({ ...prev, progress: prev.progress + 1 }))}>
                                    +
                                </Button>
                            </div>
                        </div>
                        ...
                        {/* Overall Rating */}
                        <div className="grid grid-cols-[120px_1fr] items-center gap-4">
                            <label className="font-bold text-base">Overall Rating</label>
                        ...
                        <div className="grid grid-cols-[120px_1fr] gap-4">
                            <label className="font-bold text-base pt-2">Notes</label>
                            <Textarea
