                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                        {backdrops.map((src, index) => (
                            <motion.div
                                key={`backdrop-${index}`}
                                layoutId={`image-${src}`}
                                className="relative aspect-video w-full overflow-hidden rounded-xl bg-gradient-to-r from-gray-800 via-gray-700 to-gray-800 bg-[length:200%_100%] animate-shimmer shadow-lg group cursor-pointer border border-white/10"
                            ...
                            >
                                <Image
                                    ...
                                    className="object-cover transition-all duration-500 group-hover:scale-110 opacity-0"
                                    loading="lazy"
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
                        {posters.map((src, index) => (
                            <motion.div
                                key={`poster-${index}`}
                                layoutId={`image-${src}`}
                                className="relative aspect-[2/3] w-full overflow-hidden rounded-xl bg-gradient-to-r from-gray-800 via-gray-700 to-gray-800 bg-[length:200%_100%] animate-shimmer shadow-lg group cursor-pointer border border-white/10"
