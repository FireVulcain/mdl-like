...
export default async function Home() {
    ...
    return (
        <div className="container py-8 space-y-24 m-auto max-w-[85%]">
            ...
            <section className="relative space-y-8 bg-linear-to-br from-white/3 to-white/1 backdrop-blur-sm p-8 rounded-xl border border-white/10 shadow-lg overflow-hidden">
                ...
                <div className="flex items-center justify-between">
                    <div className="space-y-2">
                        <div className="flex items-center gap-3">
                            <h2 className="text-3xl font-bold text-white">K-Drama Universe</h2>
                ...
                <div className="space-y-10">
                        ...
                        <ScrollArea className="w-full whitespace-nowrap -mx-4 px-4">
                            <div className="flex gap-6 py-4 px-4">
                                {kdramas.trending.map((media) => (
                                    <div key={media.id} className="w-55 shrink-0 transition-transform hover:scale-105 duration-300">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center gap-3">
                            <div className="w-1 h-6 bg-linear-to-b from-emerald-500 to-cyan-500 rounded-full" />
